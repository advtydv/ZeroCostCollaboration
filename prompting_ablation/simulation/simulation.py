...
from .prompt_ablation import PromptAblation
...
class SimulationManager:
    ...
    def __init__(self, config: dict, sim_logger: SimulationLogger, 
        ...
        self.prompt_ablation = PromptAblation(config)
        ...
        self.prompt_ablation.register_information_pieces(self.info_manager.information_pieces)
